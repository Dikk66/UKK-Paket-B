...
- Name: api/02-auth-member.spec.ts >> 02 - Auth Member >> B9: Register member - Field wajib kosong
- Location: tests/api/02-auth-member.spec.ts:32:7

# Error details

```
Error: Field 'instansi' yang kosong seharusnya mengembalikan status 400
